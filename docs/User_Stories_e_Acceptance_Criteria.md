...
_Given_ an existing user on the login screen  
_When_ they enter a valid e‑mail & password and press **Login**  
_Then_ SYS authenticates via Supabase Auth and redirects:  
&nbsp;&nbsp;• TR → Dashboard • CL → next required step (anamnese / workout /
dashboard).
